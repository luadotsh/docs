export const metadata = {
  title: 'Pagination',
  description:
    'This guide explains how to work with paginated responses when querying the Mercantive API pagination.',
}

# Pagination
How to work with paginated responses when querying the Mercantive API. By default, responses are paginated with 25 results per page.
