export const metadata = {
  title: 'Errors',
  description:
    'This guide explains how the Mercantive API handles errors and what you can expect when things go wrong.',
}

# Errors

This guide explains how the Mercantive API handles errors and what you can expect when things go wrong. While we strive for perfection, errors can occur. Let's explore the status codes and error types you might encounter. {{ className: 'lead' }}
...
<Note>
  ...
  and our documentation before reaching out to Mercantive support.
</Note>
...
Here's an overview of the status code categories returned by the Mercantive API. Use these to understand the outcome of your request.
