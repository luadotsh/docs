  ...
  return {
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links-underline': theme('colors.indigo.500 / 0.3'),
        ...
        '--tw-prose-invert-links-hover': theme('colors.indigo.500'),
        '--tw-prose-invert-links-underline': theme('colors.indigo.500 / 0.3'),
